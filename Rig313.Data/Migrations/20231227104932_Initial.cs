        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryManager = table.Column<bool>(type: "bit", nullable: false),
                    ProductManager = table.Column<bool>(type: "bit", nullable: false),
                    InventoryManager = table.Column<bool>(type: "bit", nullable: false),
                    CustomerManager = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnPending = table.Column<int>(type: "int", nullable: false),
                    OnShipped = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipmentCharge = table.Column<double>(type: "float", nullable: false),
                    TotalPrice = table.Column<double>(type: "float", nullable: false),
                    PaidAmount = table.Column<double>(type: "float", nullable: false),
                    PlacingDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProcessingDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ShippingDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
